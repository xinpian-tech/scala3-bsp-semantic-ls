...
fn readiness_method(method: &str) -> Option<Method> {
    match method {
        ...
        "textDocument/prepareCallHierarchy" => Some(Method::PrepareCallHierarchy),
        "callHierarchy/incomingCalls" => Some(Method::IncomingCalls),
        "callHierarchy/outgoingCalls" => Some(Method::OutgoingCalls),
