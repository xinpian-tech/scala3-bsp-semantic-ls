...
//! entry, and the index-backed definition/search/toplevels callbacks) and a
//! 22-op PC vtable (the language ops plus loaned-thread spawn). Both are
//! versioned and guarded by a layout canary the two sides recompute
//! independently.
//!
...
pub use abi::{
    ...
    STATUS_NOT_YET, STATUS_OK, STATUS_PANIC,
};
